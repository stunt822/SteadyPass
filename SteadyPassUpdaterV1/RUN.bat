...
:flash
%~dp0files\avrdude -v -C %~dp0files\avrdude.conf -patmega32u4 -cavr109 -P%port% -b57600 -D -V -Uflash:w:%~dp0files\SteadyPass1653.ino.hex:i
echo off
echo "                                      __  o                           "
echo "                                     /  |/                            "
...
echo "            \        ________  __ _  ___  / /__ / /_____       |      "
...
:devicenotfound
echo "Your Steady Pass Device could not be verified. Please verify your steady pass device is the only USB device plugged in and run this program again."
echo "If the issue persists, pleace contact support at Support@SteadyPass.com"
Pause
